...
public class F_PRINCIPAL extends javax.swing.JFrame { 
    ...
    private void gerenciadorDeMenus(){        
       ...
       if(nivelAcessoUsuario == 3){  
            ...
            mnuEmpresaContratoImpressoras.setVisible(false);
        }else{
    ...
    private void initComponents() {
        ...
        menuPatriLotes = new javax.swing.JMenu();
        menuEntradaEmLoteTXT = new javax.swing.JMenuItem();
        ...
        setTitle("SISTEMA CONTROLE DE PATRIMÔNIOS DA CGGM");
        ...
        menuEntradaEmLoteTXT.setText("ENTRADA");
        menuEntradaEmLoteTXT.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        menuEntradaEmLoteTXT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuEntradaEmLoteTXTActionPerformed(evt);
            }
        });
        menuPatriLotes.add(menuEntradaEmLoteTXT);

        menuSaidaEmLoteTXT.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F11, java.awt.event.InputEvent.CTRL_MASK));
        menuSaidaEmLoteTXT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/btn_Ok.jpg"))); // NOI18N
        menuSaidaEmLoteTXT.setText("SAIDA");
        menuSaidaEmLoteTXT.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        menuSaidaEmLoteTXT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuSaidaEmLoteTXTActionPerformed(evt);
            }
        });
        menuPatriLotes.add(menuSaidaEmLoteTXT);

        menuCadastro.add(menuPatriLotes);
        ...
        menuclientesvirtuais.setText("CONTROLE DE CLIENTES VIRTUAIS");
        menuclientesvirtuais.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        menuclientesvirtuais.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuclientesvirtuaisActionPerformed(evt);
            }
        });
        ...
        mnuConsultarEstacoesDisponiveis.setText("CONSULTA NOMES DE ESTAÇÕES DISPONÍVEIS PARA CADASTRO");
        ...
        menuConsultas.add(mnuImprimirMemosTransferenciaPorTipo);
        ...
        mnuMemoInserviveis.setText("GERAR MEMO DE BENS INSERVIVEIS");
...
//        }
    ...
    private void mnuReativarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuReativarClienteActionPerformed
        ...
        conexao.conectar();
        conexao.ExecutarPesquisaSQL("select * from tblclientes where status='INATIVO' and tipo='F'");
        try {
            if (conexao.rs.next())
            {
                tabela = "TBLCLIENTES"; 
    ...
    private void menuclientesvirtuaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuclientesvirtuaisActionPerformed
        if(umabiblio.permissaoLiberada()){  
            ...
            F_CLIENTESVIRTUAIS frm = new F_CLIENTESVIRTUAIS(); 
            frm.setVisible(true); 
        }
...
//    }
    ...
    private javax.swing.JMenuItem menuSaidaEmLoteTXT;
